...
class Notice_EweiShopV2Model 
{
	...
	public function sendTeamMessage($orderid = '0', $delRefund = false) 
	{
		...
		if ($delRefund == true) 
		{
			...
			$msg = array( 'first' => array('value' => '您的订单已经完成退款！', 'color' => '#4a5077'), 'keyword1' => array('title' => '退款金额', 'value' => '¥' . $price . '元', 'color' => '#4a5077'), 'keyword2' => array('title' => '商品详情', 'value' => $goods . $orderpricestr, 'color' => '#4a5077'), 'keyword3' => array('title' => '订单编号', 'value' => $order['orderno'], 'color' => '#4a5077'), 'remark' => array('value' => '退款金额 ¥' . $price . $refundtype . "\r\n" . ' 【' . $shop['name'] . '】期待您再次购物！', 'color' => '#4a5077') );
		...
		else if ($order['status'] == 1) 
		{
			if ($order['success'] == 1) 
			{
				...
				{
					$msg = array( 'first' => array('value' => '您参加的拼团已经成功组团！', 'color' => '#4a5077'), 'keyword1' => array('title' => '订单号', 'value' => $value['orderno'], 'color' => '#4a5077'), 'keyword2' => array('title' => '时间', 'value' => date('Y-m-d H:i', $value['paytime']), 'color' => '#4a5077'), 'keyword3' => array('title' => '商品', 'value' => $order_goods['title'], 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
				...
				$msgteam = array( 'first' => array('value' => '拼团已经成功组团！', 'color' => '#4a5077'), 'keyword1' => array('title' => '商品信息', 'value' => $goods, 'color' => '#4a5077'), 'keyword2' => array('title' => '付款金额', 'value' => $orderpricestr, 'color' => '#4a5077'), 'keyword3' => array('title' => '预计发货时间', 'value' => date('Y-m-d H:i:s', time()), 'color' => '#4a5077'), 'remark' => array('value' => $remarkteam, 'color' => '#4a5077') );
			...
			else if ($order['success'] == -1) 
			{
				...
				$msg = array( 'first' => array('value' => '您参加的拼团组团失败！', 'color' => '#4a5077'), 'keyword1' => array('title' => '店铺', 'value' => $shop['name'], 'color' => '#4a5077'), 'keyword2' => array('title' => '通知时间', 'value' => date('Y-m-d H:i:s', time()), 'color' => '#4a5077'), 'keyword3' => array('title' => '商品', 'value' => $order_goods['title'], 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
				foreach ($order as $key => $value ) 
				{
			...
			else if ($order['success'] == 0) 
			{
				...
				$msg = array( 'first' => array('value' => '您的订单已提交成功！', 'color' => '#4a5077'), 'keyword1' => array('title' => '店铺', 'value' => $shop['name'], 'color' => '#4a5077'), 'keyword2' => array('title' => '下单时间', 'value' => date('Y-m-d H:i:s', $order['createtime']), 'color' => '#4a5077'), 'keyword3' => array('title' => '商品', 'value' => $goods, 'color' => '#4a5077'), 'keyword4' => array('title' => '金额', 'value' => $orderpricestr, 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
				$this->sendGroupsNotice(array('openid' => $openid, 'tag' => 'groups_pay', 'default' => $msg, 'url' => $url, 'datas' => $datas));
				if (!($order['is_team'])) 
				{
					$tm = m('common')->getSysset('notice');
					$remarkteam = '单购订单成功了，准备发货';
					$msgteam = array( 'first' => array('value' => '单购订单成功了！', 'color' => '#4a5077'), 'keyword1' => array('title' => '商品信息', 'value' => $goods, 'color' => '#4a5077'), 'keyword2' => array('title' => '付款金额', 'value' => $orderpricestr, 'color' => '#4a5077'), 'keyword3' => array('title' => '预计发货时间', 'value' => date('Y-m-d H:i:s', time()), 'color' => '#4a5077'), 'remark' => array('value' => $remarkteam, 'color' => '#4a5077') );
					$business = explode(',', $tm['openid']);
					foreach ($business as $value ) 
					{
						$this->sendGroupsNotice(array('openid' => $value, 'tag' => 'groups_teamsend', 'default' => $msgteam, 'datas' => $datas));
		...
		else if ($order['status'] == 2) 
		{
			...
			$msg = array( 'first' => array('value' => '您的订单已发货！', 'color' => '#4a5077'), 'keyword1' => array('title' => '店铺', 'value' => $shop['name'], 'color' => '#4a5077'), 'keyword2' => array('title' => '发货时间', 'value' => date('Y-m-d H:i:s', $order['sendtime']), 'color' => '#4a5077'), 'keyword3' => array('title' => '商品', 'value' => $order_goods['title'], 'color' => '#4a5077'), 'keyword4' => array('title' => '快递公司', 'value' => $order['expresscom'], 'color' => '#4a5077'), 'keyword5' => array('title' => '快递单号', 'value' => $order['expresssn'], 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
	...
	public function sendOrderMessage($orderid = '0', $delRefund = false) 
	{
		...
		if ($delRefund) 
		{
			...
			if (!(empty($order['refundid']))) 
			{
				...
				else if ($refund['status'] == 3) 
				{
					...
					$msg = array( 'first' => array('value' => '您的' . $r_type[$refund['rtype']] . '申请已经通过！', 'color' => '#4a5077'), 'keyword1' => array('title' => '订单编号', 'value' => $order['ordersn'], 'color' => '#4a5077'), 'keyword2' => array('title' => '当前进度', 'value' => '您的' . $r_type[$refund['rtype']] . '申请已经通过！', 'color' => '#4a5077'), 'keyword3' => array('title' => '商品名称', 'value' => $goods . $orderpricestr, 'color' => '#4a5077'), 'keyword4' => array('title' => '退款金额', 'value' => ($refund['rtype'] == 3 ? '-' : '¥' . $refund['applyprice'] . '元'), 'color' => '#4a5077'), 'remark' => array('value' => "\r\n" . '请您根据商家提供的退货地址将商品寄回！' . $refund_address . '', 'color' => '#4a5077') );
				...
				else if ($refund['status'] == 5) 
				{
					...
					$msg = array( 'first' => array('value' => '您的换货物品已经发货！', 'color' => '#4a5077'), 'keyword1' => array('title' => '订单编号', 'value' => $order['ordersn'], 'color' => '#4a5077'), 'keyword2' => array('title' => '当前进度', 'value' => '您的换货物品已经发货！快递公司: ' . $refund['rexpresscom'] . ' 快递单号: ' . $refund['rexpresssn'], 'color' => '#4a5077'), 'keyword3' => array('title' => '商品名称', 'value' => $goods . $orderpricestr, 'color' => '#4a5077'), 'keyword4' => array('title' => '退款金额', 'value' => ($refund['rtype'] == 3 ? '-' : '¥' . $refund['applyprice'] . '元'), 'color' => '#4a5077'), 'remark' => array('value' => "\r\n" . '我们正加速送到您的手上，请您耐心等候。', 'color' => '#4a5077') );
					$this->sendNotice(array('openid' => $openid, 'tag' => 'refunding', 'default' => $msg, 'url' => $url, 'datas' => $datas));
					com_run('sms::callsms', array('tag' => 'refunding', 'datas' => $datas, 'mobile' => $member['mobile']));
				}
				else if ($refund['status'] == 1) 
				{
					...
					else 
					{
						...
						$msg = array( 'first' => array('value' => '您的订单已经完成退款！', 'color' => '#4a5077'), 'orderProductPrice' => array('title' => '退款金额', 'value' => '¥' . $refund['price'] . '元', 'color' => '#4a5077'), 'orderProductName' => array('title' => '商品详情', 'value' => $goods . $orderpricestr, 'color' => '#4a5077'), 'orderName' => array('title' => '订单编号', 'value' => $order['ordersn'], 'color' => '#4a5077'), 'remark' => array('value' => "\r\n" . ' 退款金额 ¥' . $refund['price'] . $refundtype . "\r\n" . ' 【' . $shop['name'] . '】期待您再次购物！', 'color' => '#4a5077') );
					}
				...
				else if ($refund['status'] == -1) 
				{
					...
					$msg = array( 'first' => array('value' => '您的' . $r_type[$refund['rtype']] . '申请被商家驳回，可与商家协商沟通！', 'color' => '#4a5077'), 'orderProductPrice' => array('title' => '退款金额', 'value' => '¥' . $refund['price'] . '元', 'color' => '#4a5077'), 'orderProductName' => array('title' => '商品详情', 'value' => $goods . $orderpricestr, 'color' => '#4a5077'), 'orderName' => array('title' => '订单编号', 'value' => $order['ordersn'], 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
					$this->sendNotice(array('openid' => $openid, 'tag' => 'refund2', 'default' => $msg, 'url' => $url, 'datas' => $datas, 'mobile' => $buyerinfo_mobile));
		...
		if ($order['status'] == -1) 
		{
			...
			$this->sendNotice(array('openid' => $openid, 'tag' => 'cancel', 'default' => $msg, 'url' => $url, 'datas' => $datas, 'mobile' => $buyerinfo_mobile));
		...
		else if ($order['status'] == 0) 
		{
			...
			if (is_array($newtype) && in_array('0', $newtype)) 
			{
				...
				$msg = array( 'first' => array('value' => '订单下单通知!', 'color' => '#4a5077'), 'keyword1' => array('title' => '时间', 'value' => date('Y-m-d H:i:s', $order['createtime']), 'color' => '#4a5077'), 'keyword2' => array('title' => '商品名称', 'value' => $goods . $orderpricestr, 'color' => '#4a5077'), 'keyword3' => array('title' => '订单号', 'value' => $order['ordersn'], 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
				...
				if (!(empty($tm['openid']))) 
				{
					...
					foreach ($openids as $tmopenid ) 
					{
						...
						$this->sendNotice(array('openid' => $tmopenid, 'tag' => 'saler_submit', 'default' => $msg, 'datas' => $datas));
					}
				}
			}
			...
			foreach ($order_goods as $og ) 
			{
				if (!(empty($og['noticeopenid']))) 
				{
					...
					if (empty($og['noticetype']) || (is_array($noticetype) && in_array('0', $noticetype))) 
					{
						...
						$msg = array( 'first' => array('value' => '商品下单通知!', 'color' => '#4a5077'), 'keyword1' => array('title' => '时间', 'value' => date('Y-m-d H:i:s', $order['createtime']), 'color' => '#4a5077'), 'keyword2' => array('title' => '商品名称', 'value' => $goodstr, 'color' => '#4a5077'), 'keyword3' => array('title' => '订单号', 'value' => $order['ordersn'], 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
						$datas[] = array('name' => '单品详情', 'value' => $goodstr);
						$this->sendNotice(array('openid' => $og['noticeopenid'], 'tag' => 'saler_submit', 'default' => $msg, 'datas' => $datas));
					}
				}
			}
			if (empty($usernotice['submit'])) 
			{
				...
				$msg = array( 'first' => array('value' => '您的订单已提交成功！', 'color' => '#4a5077'), 'keyword1' => array('title' => '店铺', 'value' => $shop['name'], 'color' => '#4a5077'), 'keyword2' => array('title' => '下单时间', 'value' => date('Y-m-d H:i:s', $order['createtime']), 'color' => '#4a5077'), 'keyword3' => array('title' => '商品', 'value' => $goods, 'color' => '#4a5077'), 'keyword4' => array('title' => '金额', 'value' => '¥' . $order['price'] . '元(含运费' . $order['dispatchprice'] . '元)', 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
		...
		else if ($order['status'] == 1) 
		{
			...
			if (is_array($newtype) && in_array('1', $newtype)) 
			{
				...
				$msg = array( 'first' => array('value' => '订单下单支付通知!', 'color' => '#4a5077'), 'keyword1' => array('title' => '时间', 'value' => date('Y-m-d H:i:s', $order['createtime']), 'color' => '#4a5077'), 'keyword2' => array('title' => '商品名称', 'value' => $goods . $orderpricestr, 'color' => '#4a5077'), 'keyword3' => array('title' => '订单号', 'value' => $order['ordersn'], 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
				$account = m('common')->getAccount();
				if (!(empty($tm['openid']))) 
				{
					$openids = explode(',', $tm['openid']);
					foreach ($openids as $tmopenid ) 
					{
						...
						$this->sendNotice(array('openid' => $tmopenid, 'tag' => 'saler_pay', 'default' => $msg, 'datas' => $datas));
					}
				}
			}
			...
			foreach ($order_goods as $og ) 
			{
				...
				if (($og['noticetype'] == '1') || (is_array($noticetype) && in_array('1', $noticetype))) 
				{
					...
					$datas[] = array('name' => '单品详情', 'value' => $goodstr);
					$this->sendNotice(array('openid' => $og['noticeopenid'], 'tag' => 'saler_pay', 'default' => $msg, 'datas' => $datas));
				}
			}
			if (empty($usernotice['pay'])) 
			{
				...
				$msg = array( 'first' => array('value' => '您已支付成功订单！', 'color' => '#4a5077'), 'keyword1' => array('title' => '订单', 'value' => $order['ordersn'], 'color' => '#4a5077'), 'keyword2' => array('title' => '支付状态', 'value' => '支付成功', 'color' => '#4a5077'), 'keyword3' => array('title' => '支付日期', 'value' => date('Y-m-d H:i:s', $order['paytime']), 'color' => '#4a5077'), 'keyword4' => array('title' => '商户', 'value' => $shop['name'], 'color' => '#4a5077'), 'keyword5' => array('title' => '金额', 'value' => '¥' . $order['price'] . '元(含运费' . $order['dispatchprice'] . '元)', 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
			...
			if (($order['dispatchtype'] == 1) && empty($order['isverify'])) 
			{
				...
				$msg = array( 'first' => array('value' => '自提订单提交成功!', 'color' => '#4a5077'), 'keyword1' => array('title' => '自提码', 'value' => $order['verifycode'], 'color' => '#4a5077'), 'keyword2' => array('title' => '商品详情', 'value' => $goods . $orderpricestr, 'color' => '#4a5077'), 'keyword3' => array('title' => '提货地址', 'value' => $store['address'], 'color' => '#4a5077'), 'keyword4' => array('title' => '提货时间', 'value' => $store['saletime'], 'color' => '#4a5077'), 'remark' => array('value' => "\r\n" . '请您到选择的自提点进行取货, 自提联系人: ' . $store['realname'] . ' 联系电话: ' . $store['mobile'], 'color' => '#4a5077') );
		...
		else if ($order['status'] == 2) 
		{
			if (empty($order['dispatchtype'])) 
			{
				...
				$msg = array( 'first' => array('value' => '您的宝贝已经发货！', 'color' => '#4a5077'), 'keyword1' => array('title' => '订单内容', 'value' => '【' . $order['ordersn'] . '】' . $goods . $orderpricestr, 'color' => '#4a5077'), 'keyword2' => array('title' => '物流服务', 'value' => $order['expresscom'], 'color' => '#4a5077'), 'keyword3' => array('title' => '快递单号', 'value' => $order['expresssn'], 'color' => '#4a5077'), 'keyword4' => array('title' => '收货信息', 'value' => '地址: ' . $address['province'] . ' ' . $address['city'] . ' ' . $address['area'] . ' ' . $address['address'] . '收件人: ' . $address['realname'] . ' (' . $address['mobile'] . ') ', 'color' => '#4a5077'), 'remark' => array('value' => "\r\n" . '我们正加速送到您的手上，请您耐心等候。', 'color' => '#4a5077') );
		...
		else if ($order['status'] == 3) 
		{
			...
			if ($pv && !(empty($order['virtual']))) 
			{
				...
				{
					$virtual_str = "\n" . $buyerinfo . "\n" . $order['virtual_str'];
					$msg = array( 'first' => array('value' => '您购物的物品已自动发货!', 'color' => '#4a5077'), 'keyword1' => array('title' => '商品名称', 'value' => $goods . $orderpricestr, 'color' => '#4a5077'), 'keyword2' => array('title' => '订单号', 'value' => '【' . $order['ordersn'] . '】', 'color' => '#4a5077'), 'keyword3' => array('title' => '订单金额', 'value' => '¥' . $order['price'] . '元', 'color' => '#4a5077'), 'keyword4' => array('title' => '卡密信息', 'value' => $virtual_str, 'color' => '#4a5077'), 'remark' => array('title' => '', 'value' => "\r\n" . '【' . $shop['name'] . '】感谢您的支持与厚爱，欢迎您的再次购物！', 'color' => '#4a5077') );
				...
				if (is_array($newtype) && in_array('2', $newtype)) 
				{
					...
					if (!(empty($tm['openid']))) 
					{
						...
						foreach ($openids as $tmopenid ) 
						{
							...
							$this->sendNotice(array('openid' => $tmopenid, 'tag' => 'saler_finish', 'default' => $msg, 'datas' => $datas));
						}
					}
				}
				...
				foreach ($order_goods as $og ) 
				{
					...
					if (($og['noticetype'] == '2') || (is_array($noticetype) && in_array('2', $noticetype))) 
					{
						...
						$datas[] = array('name' => '单品详情', 'value' => $goodstr);
						$this->sendNotice(array('openid' => $og['noticeopenid'], 'tag' => 'saler_finish', 'default' => $msg, 'datas' => $datas));
					}
				}
			}
	...
	public function sendMemberUpgradeMessage($openid = '', $oldlevel = NULL, $level = NULL) 
	{
		...
		$message = array( 'first' => array('value' => '亲爱的' . $member['nickname'] . ', 恭喜您成功升级！', 'color' => '#4a5077'), 'keyword1' => array('title' => '任务名称', 'value' => '会员升级', 'color' => '#4a5077'), 'keyword2' => array('title' => '通知类型', 'value' => '您会员等级从 ' . $oldlevelname . ' 升级为 ' . $level['levelname'] . ', 特此通知!', 'color' => '#4a5077'), 'remark' => array('value' => "\r\n" . '您即可享有' . $level['levelname'] . '的专属优惠及服务！', 'color' => '#4a5077') );
		...
		$this->sendNotice(array('openid' => $openid, 'tag' => 'upgrade', 'default' => $message, 'url' => $detailurl, 'datas' => $datas));
	...
	public function sendMemberLogMessage($log_id = '', $channel = 0) 
	{
		...
		if ($log_info['type'] == 0) 
		{
			...
			if ($log_info['status'] == 1) 
			{
				...
				$message = array( 'first' => array('value' => '恭喜您充值成功!', 'color' => '#4a5077'), 'money' => array('title' => '充值金额', 'value' => '¥' . $log_info['money'] . '元', 'color' => '#4a5077'), 'product' => array('title' => '充值方式', 'value' => $type, 'color' => '#4a5077'), 'remark' => array('value' => "\r\n" . '谢谢您对我们的支持！', 'color' => '#4a5077') );
			...
			else if ($log_info['status'] == 3) 
			{
				...
				$message = array( 'first' => array('value' => '充值退款成功!', 'color' => '#4a5077'), 'reason' => array('title' => '退款原因', 'value' => '【' . $_W['shopset']['shop']['name'] . '】充值退款', 'color' => '#4a5077'), 'refund' => array('title' => '退款金额', 'value' => '¥' . $log_info['money'] . '元', 'color' => '#4a5077'), 'remark' => array('value' => "\r\n" . '退款成功，请注意查收! 谢谢您对我们的支持！', 'color' => '#4a5077') );
		...
		else if ($log_info['type'] == 1) 
		{
			...
			if ($log_info['status'] == 0) 
			{
				...
				$message = array( 'first' => array('value' => '提现申请已经成功提交!', 'color' => '#4a5077'), 'money' => array('title' => '提现金额/到账金额', 'value' => '¥' . $log_info['money'] . '元/¥' . $realmoeny . '元', 'color' => '#4a5077'), 'timet' => array('title' => '提现时间', 'value' => date('Y-m-d H:i:s', $log_info['createtime']), 'color' => '#4a5077'), 'remark' => array('value' => "\r\n" . '请等待我们的审核并打款！', 'color' => '#4a5077') );
			...
			else if ($log_info['status'] == 1) 
			{
				...
				$message = array( 'first' => array('value' => '恭喜您成功提现!', 'color' => '#4a5077'), 'money' => array('title' => '提现金额/到账金额', 'value' => '¥' . $log_info['money'] . '元/¥' . $realmoeny . '元', 'color' => '#4a5077'), 'timet' => array('title' => '提现时间', 'value' => date('Y-m-d H:i:s', $log_info['createtime']), 'color' => '#4a5077'), 'remark' => array('value' => "\r\n" . '感谢您的支持！', 'color' => '#4a5077') );
			...
			else if ($log_info['status'] == -1) 
			{
				...
				$message = array( 'first' => array('value' => '抱歉，提现申请审核失败!', 'color' => '#4a5077'), 'money' => array('title' => '提现金额/到账金额', 'value' => '¥' . $log_info['money'] . '元/¥' . $realmoeny . '元', 'color' => '#4a5077'), 'timet' => array('title' => '提现时间', 'value' => date('Y-m-d H:i:s', $log_info['createtime']), 'color' => '#4a5077'), 'remark' => array('value' => "\r\n" . '有疑问请联系客服，谢谢您的支持！', 'color' => '#4a5077') );
	...
	public function sendMessage($openid, $params, $type) 
	{
		...
		if ($type == 'orderstatus') 
		{
			$datas = array( array('name' => '粉丝昵称', 'value' => $member['nickname']), array('name' => '修改时间', 'value' => time()), array('name' => '订单编号', 'value' => $params['ordersn']), array('name' => '原收货地址', 'value' => $params['olddata']), array('name' => '新收货地址', 'value' => $params['data']), array('name' => '订单原价格', 'value' => $params['olddata']), array('name' => '订单新价格', 'value' => $params['data']) );
			$msg = array( 'first' => array('value' => $params['title'] . ' 修改提醒！', 'color' => '#4a5077'), 'OrderSn' => array('title' => '订单编号', 'value' => $params['ordersn'], 'color' => '#4a5077'), 'OrderStatus' => array('title' => '订单状态', 'value' => '已修改', 'color' => '#4a5077'), 'remark' => array('value' => "\r\n" . '原收货地址 : ' . $params['olddata'] . "\r\n" . '新收货地址 : ' . $params['data'], 'color' => '#4a5077') );
			if ($params['type'] == '1') 
			{
				$msg['remark'] = array('value' => "\r\n" . '订单原价格 : ' . $params['olddata'] . '元,' . "\r\n" . '订单新价格 : ' . $params['data'] . '元.', 'color' => '#4a5077');
			}
			$this->sendNotice(array('openid' => $openid, 'tag' => 'orderstatus', 'default' => $msg, 'url' => $params['url'], 'datas' => $datas));
