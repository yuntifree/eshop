...
class Default_EweiShopV2Page extends PluginWebPage 
{
	...
	private function post($data) 
	{
		...
		if (0 < $defaultcount) 
		{
			...
			$default['successtasker'] = array( 'first' => array('value' => $data['succestaskerfirst'], 'color' => $data['succestaskerfirstcolor']), 'keyword1' => array('value' => $data['succestaskername'], 'color' => $data['succestaskernamecolor']), 'keyword2' => array('value' => $data['succestaskertype'], 'color' => $data['succestaskertypecolor']), 'remark' => array('value' => $data['succestaskerremark'], 'color' => $data['succestaskerremarkcolor']) );
			$default['successscaner'] = array( 'first' => array('value' => $data['successcanerfirst'], 'color' => $data['successcanerfirstcolor']), 'keyword1' => array('value' => $data['successcanername'], 'color' => $data['successcanernamecolor']), 'keyword2' => array('value' => $data['successcanertype'], 'color' => $data['successcanertypecolor']), 'remark' => array('value' => $data['successcanerremark'], 'color' => $data['successcanerremarkcolor']) );
			$default['complete'] = array( 'first' => array('value' => $data['completefirst'], 'color' => $data['completefirstcolor']), 'keyword1' => array('value' => $data['completetaskname'], 'color' => $data['completetasknamecolor']), 'keyword2' => array('value' => $data['completetype'], 'color' => $data['completetypecolor']), 'remark' => array('value' => $data['completeremark'], 'color' => $data['completeremarkcolor']) );
			$default['rankcomplete'] = array( 'first' => array('value' => $data['rankcompletefirst'], 'color' => $data['rankcompletefirstcolor']), 'keyword1' => array('value' => $data['rankcompletetaskname'], 'color' => $data['rankcompletetasknamecolor']), 'keyword2' => array('value' => $data['rankcompletetype'], 'color' => $data['rankcompletetypecolor']), 'remark' => array('value' => $data['rankcompleteremark'], 'color' => $data['rankcompleteremarkcolor']) );
			$default['completed'] = array( 'first' => array('value' => $data['completedfirst'], 'color' => $data['completedfirstcolor']), 'keyword1' => array('value' => $data['completedtaskname'], 'color' => $data['completedtasknamecolor']), 'keyword2' => array('value' => $data['completedtype'], 'color' => $data['completedtypecolor']), 'remark' => array('value' => $data['completedremark'], 'color' => $data['completedremarkcolor']) );
			$default['is_completed'] = intval($data['is_completed']);
			$default['fail'] = array( 'first' => array('value' => '', 'color' => ''), 'keyword1' => array('value' => $data['failtaskname'], 'color' => $data['failtasknamecolor']), 'keyword2' => array('value' => $data['failtasknametype'], 'color' => $data['failtasknametypecolor']), 'remark' => array('value' => $data['failtasknameremark'], 'color' => $data['failtasknameremarkcolor']) );
			$default['self'] = array( 'first' => array('value' => '', 'color' => ''), 'keyword1' => array('value' => $data['scanselftaskname'], 'color' => $data['scanselftasknamecolor']), 'keyword2' => array('value' => $data['scanselftype'], 'color' => $data['scanselftypecolor']), 'remark' => array('value' => $data['scanselfremark'], 'color' => $data['scanselfremarkcolor']) );
		...
		$default['completed'] = array( 'first' => array('value' => $data['completedfirst'], 'color' => $data['completedfirstcolor']), 'keyword1' => array('value' => $data['completedtaskname'], 'color' => $data['completedtasknamecolor']), 'keyword2' => array('value' => $data['completedtype'], 'color' => $data['completedtypecolor']), 'remark' => array('value' => $data['completedremark'], 'color' => $data['completedremarkcolor']) );
		$default['is_completed'] = intval($data['is_completed']);
		$default['fail'] = array( 'first' => array('value' => '', 'color' => '#4a5077'), 'keyword1' => array('value' => $data['failtaskname'], 'color' => $data['failtasknamecolor']), 'keyword2' => array('value' => $data['failtasknametype'], 'color' => $data['failtasknametypecolor']), 'remark' => array('value' => $data['failtasknameremark'], 'color' => $data['failtasknameremarkcolor']) );
		$default['self'] = array( 'first' => array('value' => '', 'color' => ''), 'keyword1' => array('value' => $data['scanselftaskname'], 'color' => $data['scanselftasknamecolor']), 'keyword2' => array('value' => $data['scanselftype'], 'color' => $data['scanselftypecolor']), 'remark' => array('value' => $data['scanselfremark'], 'color' => $data['scanselfremarkcolor']) );
		$default = serialize($default);
