...
class Apply_EweiShopV2Page extends PluginWebPage 
{
	public function main() 
	{
		...
		else if (!(cv('commission.apply.view' . $status))) 
		{
			$this->message('你没有相应的权限查看');
		}
