define(['jquery.ui'], function (ui) {
    ...
    modal.initEditor = function (scroll) {
        ...
        if (goodsSelector > 0) {
            ...
            if (_this.data('goodstype') == 1) {
                url = biz.url('creditshop/goods/query', null, modal.merch)
            }
    ...
    modal.initTemp = function () {
        ...
        $("#saveTemp", "#saveTempModal").unbind('click').click(function () {
            ...
            if (modal.type == 1) {
                var posturl = biz.url("diypage/page/diy/savetemp")
            } else if (modal.type > 1 && modal.type < 99) {
                var posturl = biz.url("diypage/page/sys/savetemp")
            }
            $.post(posturl, {
                type: modal.type,
                cate: tempcate,
